            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "card_types": {
                        ...
                        "items": {
                            "type": "string",
                            "enum": ["citation", "summary", "definition"],
                        },
...
"""
        ...
        try:
            ...
            response += (
                f"- Web API: {'✓' if availability['web_api'] else '✗'}\n"
            )
            ...
            return [
                types.TextContent(
                    type="text", text=f"Failed to connect to Zotero: {str(e)}"
                )
            ]
        ...
        if not zotero_connector:
            return [
                types.TextContent(
                    type="text",
                    text="Please connect to Zotero first using the connect_zotero tool",
                )
            ]
        ...
        try:
            ...
            if not items:
                return [
                    types.TextContent(
                        type="text", text=f"No items found for query: {query}"
                    )
                ]
            ...
            return [
                types.TextContent(
                    type="text", text=f"Error searching Zotero: {str(e)}"
                )
            ]
        ...
        try:
            ...
            if not collections:
                return [
                    types.TextContent(
                        type="text",
                        text="No collections found in your Zotero library",
                    )
                ]
            ...
            for collection in collections:
                if "collectionName" in collection:  # Local DB format
                    ...
                    "data" in collection and "name" in collection["data"]
                ):  # Web API format
            ...
            return [
                types.TextContent(
                    type="text", text=f"Error getting collections: {str(e)}"
                )
            ]
        ...
        try:
            ...
            if item_keys:
                ...
                return [
                    types.TextContent(
                        type="text",
                        text="Either item_keys or collection_id must be provided",
                    )
                ]
            ...
            if not items:
                return [
                    types.TextContent(
                        type="text",
                        text="No items found to generate flashcards from",
                    )
                ]
            ...
            for item in items:
                ...
                if "citation" in card_types:
                    citation = zotero_connector.format_citation(
                        item, citation_style
                    )
                    flashcard = FlashcardGenerator.create_front_back_card(
                        f"Cite: {metadata['title']}", citation
                    )
            ...
            if not flashcards:
                return [
                    types.TextContent(
                        type="text",
                        text="No flashcards could be generated from the selected items",
                    )
                ]

            # Create complete LaTeX document
            result = FlashcardGenerator.create_latex_document(
                flashcards, "Zotero Flashcards"
            )
            ...
            return [
                types.TextContent(
                    type="text",
                    text=f"Error generating flashcards from Zotero: {str(e)}",
                )
            ]
        ...
        if not vault_path:
            return [
                types.TextContent(type="text", text="Vault path is required")
            ]
        ...
        try:
            ...
            if not obsidian_connector.is_available():
                return [
                    types.TextContent(
                        type="text",
                        text=f"Cannot access Obsidian vault at: {vault_path}",
                    )
                ]
            ...
            return [
                types.TextContent(
                    type="text",
                    text=f"Failed to connect to Obsidian vault: {str(e)}",
                )
            ]
        ...
        if not obsidian_connector:
            return [
                types.TextContent(
                    type="text",
                    text="Please connect to Obsidian vault first using the connect_obsidian tool",
                )
            ]
        ...
        try:
            ...
            return [
                types.TextContent(
                    type="text",
                    text=f"Error searching Obsidian vault: {str(e)}",
                )
            ]
        ...
        try:
            ...
            return [
                types.TextContent(
                    type="text", text=f"Error getting vault stats: {str(e)}"
                )
            ]
        ...
        content_types = arguments.get(
            "content_types", ["headers", "definitions", "lists"]
        )
        card_type = arguments.get("card_type", "front-back")
        ...
        try:
            ...
            if note_names:
                ...
                notes_to_process = obsidian_connector.get_notes_by_tag(
                    tag_filter
                )
            else:
                return [
                    types.TextContent(
                        type="text",
                        text="Either note_names or tag_filter must be provided",
                    )
                ]
            ...
            if not notes_to_process:
                return [
                    types.TextContent(
                        type="text", text="No notes found to process"
                    )
                ]
            ...
            for note in notes_to_process:
                content_items = (
                    obsidian_connector.extract_content_for_flashcards(
                        note, content_types
                    )
                )
            ...
            if not all_flashcard_content:
                return [
                    types.TextContent(
                        type="text",
                        text="No suitable content found for flashcard generation",
                    )
                ]
            ...
            if not flashcards:
                return [
                    types.TextContent(
                        type="text",
                        text="No flashcards could be generated from the selected content",
                    )
                ]
            ...
            return [
                types.TextContent(
                    type="text",
                    text=f"Error generating flashcards from Obsidian: {str(e)}",
                )
            ]
